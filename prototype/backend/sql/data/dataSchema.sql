...
(
    ...
    is_last_event_for_plate_appearance BOOL DEFAULT false,
    bases_hit SMALLINT DEFAULT 0,
    runs_batted_in FLOAT DEFAULT 0,
    is_sacrifice_hit BOOL DEFAULT false,
    is_sacrifice_fly BOOL DEFAULT false,
    outs_on_play SMALLINT DEFAULT 0,
    is_double_play BOOL DEFAULT false,
    is_triple_play BOOL DEFAULT false,
    is_wild_pitch BOOL DEFAULT false,
    batted_ball_type TEXT,
    is_bunt BOOL DEFAULT false,
    errors_on_play SMALLINT DEFAULT 0,
    batter_base_after_play SMALLINT DEFAULT 0,
