...
INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (1, 'BLACK_HOLE', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (2, 'CAUGHT_STEALING', 0, 0, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (3, 'CHARM_STRIKEOUT', 1, 1, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (4, 'CHARM_WALK', 1, 0, 0, 1, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (5, 'DOUBLE', 1, 1, 1, 2, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (6, 'ELSEWHERE_ATBAT', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (7, 'FIELDERS_CHOICE', 1, 1, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (8, 'GAME_OVER', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (9, 'HIT_BY_PITCH', 1, 0, 0, 1, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (10, 'HOME_RUN', 1, 1, 1, 4, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (11, 'HOME_RUN_5', 1, 1, 1, 5, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (12, 'IMMATERIA_SWEPT', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (13, 'MIND_TRICK_STRIKEOUT', 1, 1, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (14, 'MIND_TRICK_WALK', 1, 0, 0, 1, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (16, 'OUT', 1, 1, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (18, 'QUADRUPLE', 1, 1, 1, 4, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (19, 'SACRIFICE', 1, 0, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (20, 'SECRET_BASE_ENTER', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (21, 'SECRET_BASE_EXIT', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (22, 'SHELLED_ATBAT', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (23, 'SINGLE', 1, 1, 1, 1, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (24, 'STOLEN_BASE', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (25, 'STRIKEOUT', 1, 1, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (26, 'SUN_2', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (27, 'TRIPLE', 1, 1, 1, 3, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (28, 'UNKNOWN', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (29, 'UNKNOWN_OUT', 0, 0, 0, 0, 1);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (30, 'WALK', 1, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (31, 'WILD_PITCH', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (32, 'INTENTIONAL_WALK', 1, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (33, 'TUNNELS_STOLEN_RUN', 0, 0, 0, 0, 0);

    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (34, 'GAME_START', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (35, 'INNING_TOP', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (36, 'INNING_BOTTOM', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (37, 'INNING_END', 0, 0, 0, 0, 0);
    INSERT INTO taxa.event_types (event_type_id, event_type, plate_appearance, at_bat, hit, total_bases, outs) VALUES (38, 'BATTER_UP', 0, 0, 0, 0, 0);
...
INSERT INTO taxa.attributes (attribute_id, attribute, attribute_desc, attribute_category, attribute_short, attribute_datatype, attribute_directionality) VALUES (9, 'base_thirst', 'Increases stolen base attempts.', 'baserunning', 'Bt', 'NUMERIC', 'larger');
    ...
    INSERT INTO taxa.attributes (attribute_id, attribute, attribute_desc, attribute_category, attribute_short, attribute_datatype, attribute_directionality) VALUES (96, 'fate', 'Unknown; appears to re-roll for most (but not all) stat, modification or Feedback changes.', NULL, NULL, 'INT', 'See taxonomy');
    ...
    INSERT INTO taxa.attributes (attribute_id, attribute, attribute_desc, attribute_category, attribute_short, attribute_datatype, attribute_directionality) VALUES (98, 'soul', 'Determines length of Soulscream/Soulsong; now has Consumer/eDensity/Redacted implications. Beware Chorby Soul.', NULL, NULL, 'INT', 'See taxonomy');
    INSERT INTO taxa.attributes (attribute_id, attribute, attribute_desc, attribute_category, attribute_short, attribute_datatype, attribute_directionality) VALUES (99, 'total_fingers', 'Represents instances of change to pitching stats. Players impacted by general stat buffs all receive +1 finger, regardless of the size of their buff. EPT seems to not grant fingers.', NULL, NULL, 'INT', 'See taxonomy');
...
/*
INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (0, 'd9f89a8a-c563-493e-9d64-78e4f9a55d4a', 'ATL', 'active');
    ...
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (4, 'b63be8c2-576a-4d6e-8daf-814f8bcea96f', 'DALE', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (5, '3f8bbb15-61c0-4e3f-8e4a-907a5fb1565e', 'BOS', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (6, '36569151-a2fb-43c1-9df7-2df512424c82', 'NYM', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (7, 'eb67ae5e-c4bf-46ca-bbbc-425cd34182ff', 'CAN', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (8, 'bfd38797-8404-4b38-8b82-341da28b1f83', 'CHST', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (9, '7966eb04-efcc-499b-8f03-d13916330531', 'YELL', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (10, 'b024e975-1c4a-4575-8936-a3754a08806a', 'STK', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (11, 'b72f3061-f573-40d7-832a-5ad475bd7909', 'LVRS', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (12, '979aee4a-6d80-4863-bf1c-ee1a78e06024', 'FRI', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (13, '23e4cbc1-e9cd-47fa-a35b-bfa06f726cb7', 'PIES', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (14, '105bc3ff-1320-4e37-8ef0-8d595cb95dd0', 'SEA', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (15, 'a37f9158-7f82-46bc-908c-c9e2dda7c33b', 'JAZZ', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (16, 'f02aeae2-5e6a-4098-9842-02d2273f25c7', 'HELL', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (17, 'ca3f1c8c-c025-4d8e-8eef-5be6accbeb16', 'CHI', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (18, 'adc5b394-8f76-416d-9ce9-813706877b84', 'KCBM', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (19, '747b8e4a-7e50-4638-a973-ea7950a3e739', 'TGRS', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (20, '9debc64f-74b7-4ae1-a4d6-fce0144b6ea5', 'SPY', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (21, '57ec08cc-0411-4643-b304-0e80dbc15ac7', 'CDMX', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (22, 'bb4a9de5-c924-4923-a0cb-9d1445f1ee5d', 'OHWO', 'active');
    INSERT INTO taxa.team_additional_info (team_additional_info_id, team_id, team_abbreviation, team_current_status) VALUES (23, '46358869-dce9-4a01-bfba-ac24fc56f57e', 'CORE', 'active');
*/